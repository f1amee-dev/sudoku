...
const GameControls = ({ onNewGame, difficulty, onSolve }: GameControlsProps) => {
  ...
  return (
    <div className="w-full rounded-xl glass-panel flex flex-col sm:flex-row items-center justify-between gap-3 p-4">
      <div className="flex gap-4 items-center justify-center sm:justify-start w-full sm:w-auto">
      ...
      <div className="flex gap-2 justify-center">
        <button
          ...
          className="py-2 px-3 rounded-lg glass-button text-sm font-medium"
        ...
        <button
          onClick={onNewGame}
          className="py-2 px-3 rounded-lg glass-button-primary text-sm font-medium"
